...
- Model examination, to see whether our best model holds up to our standards
- A Conclusion 
...
Also remove all time related data, since we need not to use it
...
Fields that have high correlations with the class?
